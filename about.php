...
<div class=" bg-gradient-to-r from-gray-800 to-blue-600 ">
    ...
    <section class="px-80 py-40 mx-auto">
        ...
        <p class="text-lg  text-gray-500">
            ...
            TourHobe is revolutionizing the way we book travel services. With TourHobe’s website, booking your resort, hotel, or tour package becomes more fun than you would think.
            <br></br>
            We are collaborating with the local community, who are all experts in their respective fields. They have the experience and professionalism to understand each and every customer's requirements and fulfill them. In today’s era of digitalization, where everyone has a lot of information and choice in hand, our clients still choose us. Because we provide the best rates and a wide range of choices for your accommodations and travel plans.
    ...
    <section class="bg-white ">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                ...
                <div class="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 ">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="projectImages/dev1_img.jpeg" alt="">

                        <div class="mt-4 sm:mx-4 sm:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-white">Debopriya Deb Roy</h1>

                            <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Lead Backend Developer</p>
                        </div>
                    </div>

                    <p class="mt-4 text-gray-500   group-hover:text-gray-300">I'm an undergraduate student at Ahsanullah University of Science and Techonology studying computer science and engineering.</p>
                    ...
                    <div class="flex mt-4 -mx-2">
                        ...
                        <a href="#" class="mx-2 text-gray-600  hover:text-gray-500 0 group-hover:text-white" aria-label="Github">
                            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 ">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="projectImages/dev2_img.jpg" alt="">

                        <div class="mt-4 sm:mx-4 sm:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-white">Maisha Musarrat Nabila</h1>

                            <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Lead Designer</p>
                        </div>
                    </div>

                    <p class="mt-4 text-gray-500  group-hover:text-gray-300">I'm an undergraduate student at Ahsanullah University of Science and Techonology studying computer science and engineering.
</p>
