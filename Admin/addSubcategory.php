            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input id="categoryName" type="text" name="subCategoryName" class="block w-4/5 px-4 py-2 mt-2  text-gray-700 bg-white border border-gray-200 rounded-md  dark:text-black dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                    </div>
                    ...
                    <input id="details" type="text" name="detail" class="block w-4/5 h-32 px-4 py-2 mt-2  text-gray-700 bg-white border border-gray-200 rounded-md  dark:text-black dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
...
if(isset($_POST["saveBTN"]))
{
	...
	$s="insert into subcategory(Subcatname,Catid,detail) values('" . $_POST["subCategoryName"] ."','" . $_POST["selectCategory"] . "','" . $_POST["detail"] ."')";
	mysqli_query($cn,$s);
