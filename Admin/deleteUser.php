...
<body>
    ...
    if (isset($_POST["deleteBTN"])) {
        $cn = makeconnection();
        $s = "delete from users  where Username='" . $_POST["selectUser"] . "'";
        mysqli_query($cn, $s);
        mysqli_close($cn);
    ...
    <section class="flex">
        ...
        <section class="p-6 w-full bg-grey  dark:bg-gray-500 ">
            <h2 class="mb-6 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Delete User</h2>
            ...
            <form method="post">
                <div>
                    ...
                    <div class="flex-1 hidden sm:block">
                        ...
                        <select class="w-full h-10 mt-2 px-3 text-sm border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" id="location" name="selectUser">
