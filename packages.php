                            ...
                            <div class="max-w-lg mx-2 overflow-hidden mt-4 bg-white rounded-lg shadow-md ">
                                ...
                                <div class="p-4">
                                    <div>
                                        ...
                                        <a href="packageDetails.php" class="block mt-2 text-2xl font-semibold text-gray-800 transition-colors duration-200 transform d hover:text-blue-600 "><?php echo $data[1]; ?></a>
